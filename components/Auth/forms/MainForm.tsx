...
export const MainForm: React.FC<MainFormProps> = ({ onOpenLogin }) => {
  return (
    <>
      <div>
        <Button sx={{ marginBottom: '15px' }} variant="contained" fullWidth onClick={onOpenLogin}>
        ...
        <Button onClick={onOpenLogin} sx={{ marginBottom: '15px' }} variant="contained" fullWidth>
